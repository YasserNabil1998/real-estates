...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class=""><?php echo $lang['login-sing'] ?></h4>
	<p class=""><?php echo $lang['login-text'] ?></p>
...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1"><?php echo $lang['login-email'] ?> <span>*</span></label>
		    <input type="email" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
		</div>
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1"><?php echo $lang['login-password'] ?> <span>*</span></label>
		 <input type="password" name="password" class="form-control unicase-form-control text-input" id="exampleInputPassword1" >
		</div>
		<div class="radio outer-xs">
		  	<a href="forgot-password.php" class="forgot-password pull-right"><?php echo $lang['login-forgot'] ?></a>
		</div>
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login"><?php echo $lang['login-.log'] ?></button>
	</form>					
</div>
<!-- Sign-in -->
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle"><?php echo $lang['sign-sign'] ?> </h4>
	<p class="text title-tag-line"><?php echo $lang['sign-text'] ?> </p>
	<form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
<div class="form-group">
	    	<label class="info-title" for="fullname"><?php echo $lang['sign-name'] ?>  <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input" id="fullname" name="fullname" required="required">
	  	</div>


		<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2"><?php echo $lang['sign-email'] ?>  <span>*</span></label>
	    	<input type="email" class="form-control unicase-form-control text-input" id="email" onBlur="userAvailability()" name="emailid" required >
	    	       <span id="user-availability-status1" style="font-size:12px;"></span>
	  	</div>

<div class="form-group">
	    	<label class="info-title" for="contactno"><?php echo $lang['sign-no'] ?>  <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" maxlength="10" required >
	  	</div>

<div class="form-group">
	    	<label class="info-title" for="password"><?php echo $lang['sign-passowrd'] ?>  <span>*</span></label>
	    	<input type="password" class="form-control unicase-form-control text-input" id="password" name="password"  required >
	  	</div>

<div class="form-group">
	    	<label class="info-title" for="confirmpassword"><?php echo $lang['sign-conf'] ?>  <span>*</span></label>
	    	<input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
	  	</div>


	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" id="submit"><?php echo $lang['sign-up'] ?> </button>
	</form>
	<span class="checkout-subtitle outer-top-xs"><?php echo $lang['sing-adres'] ?>  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  <?php echo $lang['sign-list1'] ?> 
		</label>
		<label class="checkbox">
		<?php echo $lang['sign-list2'] ?> 
		</label>
		<label class="checkbox">
		<?php echo $lang['sign-list3'] ?> 
		</label>
	</div>
</div>	
